...
import CertificateCard  from './HeroCard';
const HeroSection = () => {
  ...
  return (
    <div className="bg-black relative z-10 flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
      {/* Left Content */}
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-1">
            <Button className="bg-gradient-to-r from-purple-600 via-blue-600 to-pink-600 hover:from-purple-700 hover:via-blue-700 hover:to-pink-700 border-0 px-8 py-4 text-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25">
              <div className=''><Award className="w-6 h-6 mr-2 text-white" /></div>
              <p className=' text-white font-semibold'>GET STARTED</p>
            </Button>
            <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800 hover:text-white px-8 py-4 text-lg transition-all duration-300">
              View Demo
            </Button>
          </div>
      ...
      <div className="pb-20 pr-10 flex items-center justify-center">
        {/* Placeholder */}
        <div className="flex items-center justify-center text-purple-500 text-sm">
          {
            <CertificateCard/>
          }
        </div>
